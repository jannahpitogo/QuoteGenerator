...
//   req.on("end", () => {
//     //waiting for the app to finish fetching the data and inside you can process the data where you can do whatever you want with it.
...
//     } catch (error) {
//       //if the data is not the correct format the error will be caught
